...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['pending', 'fullfilled', 'cancelled']>;
...
export interface ApiPlayerPlayer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    player_number: Attribute.Integer;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gender: Attribute.Enumeration<['female', 'male', 'kids']>;
...
export interface ApiTicketTicket extends Schema.CollectionType {
  ...
  attributes: {
    ...
    awayTeamTitle: Attribute.String;
    homeTeamLogo: Attribute.Media;
    awayTeamLogo: Attribute.Media;
    venue: Attribute.String;
    type: Attribute.Enumeration<['Premium ']>;
    price: Attribute.BigInteger;
    quantity: Attribute.BigInteger;
    description: Attribute.Blocks;
    date: Attribute.Date;
    time: Attribute.Time;
    ticket_orders: Attribute.Relation<
      'api::ticket.ticket',
      'manyToMany',
...
export interface ApiTicketOrderTicketOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customer_email: Attribute.Email;
    total_price: Attribute.Float;
    status: Attribute.Enumeration<['pending', 'fulfilled', 'cancelled']>;
...
export interface ApiVideoHighlightVideoHighlight extends Schema.CollectionType {
  collectionName: 'video_highlights';
  info: {
    singularName: 'video-highlight';
    pluralName: 'video-highlights';
    displayName: 'video_highlight';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::video-highlight.video-highlight',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::video-highlight.video-highlight': ApiVideoHighlightVideoHighlight;
    }
  }
}
